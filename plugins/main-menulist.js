...
let arrayMenu = ['all', 'anime', 'update', 'berita', 'edukasi', 'news', 'random', 'maker', 'menbalas', 'game', 'xp', 'islamic', 'stiker', 'rpg', 'kerangajaib', 'quotes', 'admin', 'premium', 'internet', 'anonymous', 'nulis', 'downloader', 'tools', 'fun', 'database','quran', 'vote', 'catatan', 'absen', 'store', 'audio', 'jadibot', 'random', 'info', 'audioanime', 'owner', 'nocategory']
...
const sections = [
   {
    ...
    rows: [
        ...
        rows: [
            ...
            {title: `DONASI`, rowId: ".donasi", description: 'Gausah donasi'},
            {title: `SUBSCRIBE CHANNEL PRESIDEN`, rowId: ".zykomd", description: 'Support Zero MD dengan cara berdoa'}
            ]
        },{
