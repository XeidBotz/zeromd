...
global.tautanwa = 'https://wa.me/6289529129992'
global.wame = 'https://wa.me/6289529129992' // kalau gk punya bisa ganti pake gini wa.me/6289529129992

/*============== PAYMENT ==============*/
global.pdana = '0895 2912 9992' //dana
global.povo = '0895 2912 9992' //ovo
global.pgopay = '0895 2912 9992' //gopay
global.plinkaja = '-' //link aja
global.ppulsa = '-' //telkomsel
global.ppulsa2 = '0895 2912 9992' // kalau ada kartu lain isi aja
global.psaweria = '-'

/*============== NOMOR ==============*/
global.nomorbot = '6283842873526'
global.nomorown = '6289529129992'
global.nomorown1 = '6289529129992' //pake No Pacar lo Juga Boleh
global.namebot = 'Zero MD'
global.nameown = 'Jovan'
global.nameown1 = 'Jovan'

//⫹⫺ ╳╶╼╶╶╶╶┈ ⎝ INFO BIO DATA OWN ⎞ ┈╴╴╴╴╾╴╳ ⫹⫺
global.sig = '📷 ɪɴsᴛᴀɢʀᴀᴍ : https://instagram.com' // ig lo
/*============== Github Thanks To ==============*/
global.namagithub = 'Kaga punya' // nama github lu
...
/*============== WATERMARK ==============*/
global.gcname = 'Zero MD'//nama group kalian
global.readMore = readMore
global.wm = '                「 Zero MD 」'
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘Zero MD ˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
global.wm3 = '⫹⫺ Zero MD '
global.botdate = `⫹⫺ DATE: ${week} ${date}\n⫹⫺ 𝗧𝗶𝗺𝗲: ${wktuwib}`
global.bottime = `T I M E : ${wktuwib}`
global.titlebot = `⫹⫺ WhatsApp Bot | By Zero MD`
global.packname = 'Jovan'
global.author = 'In here'
global.week = `${week} ${date}`
global.wibb = `${wktuwib}`
global.danied = pickRandom(["𝗘𝗿𝗼𝗿 𝟰𝟬𝟰","𝘼𝙠𝙨𝙚𝙨 𝘿𝙞𝙩𝙤𝙡𝙖𝙠","️ 𝘼𝙘𝙘𝙚𝙨𝙨 𝘿𝙚𝙣𝙞𝙚𝙙 ️"])

/*============== STICKER WM ==============*/
global.stickpack = 'Jovan'
global.stickauth = `In here`
